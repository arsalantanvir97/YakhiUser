...
const PackageLevelThree = ({ match, history }) => {
      ...
      <div className='container-fluid'>
        <div className='row'>
          <div className='col-11 mx-auto'>
            <ToggleBack
              name={`GEO’GENETICS THERAPEUTIC PACKAGE LEVEL 3
            `}
            />
              ...
              <div className='row align-items-start justify-content-center mb-5 pb-5'>
                ...
                <div className='col-lg-6 col-md-10'>
                  <h2 className='p-title'>
                    GEO’GENETICS THERAPEUTIC PACKAGE LEVEL 3
                  </h2>
                  ...
                  <h4 className='big-price'>$2,000</h4>
                  <div id='field1'>
                    Quantity
...
export default PackageLevelThree
