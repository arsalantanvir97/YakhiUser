...
const Week1112Protocol = ({ match, history }) => {
      ...
      <div className='container-fluid'>
        <div className='row'>
          <div className='col-11 mx-auto'>
            <ToggleBack
              name={`WEEK 11-12 GEO’GENETICS PROTOCOL (FORMERLY AMINO ACID HERBAL PROTOCOL)
`}
            />
              ...
              <div className='row align-items-start justify-content-center mb-5 pb-5'>
                ...
                <div className='col-lg-6 col-md-10'>
                  <h2 className='p-title'>
                    WEEK 11-12 GEO’GENETICS PROTOCOL (FORMERLY AMINO ACID HERBAL
                    PROTOCOL)
                  </h2>
                          ...
                          <div className='row justify-content-between '>
                            <div className='col-12 text-center mb-3 mb-sm-4 mb-md-5 py-4 py-lg-3'>
                              <h2 className='y-tab-heading'>
                                WEEK 11-12 GEO’GENETICS PROTOCOL (FORMERLY AMINO
...
export default Week1112Protocol
