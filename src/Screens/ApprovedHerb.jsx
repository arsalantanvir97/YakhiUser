        ...
        <section className='approved-herbs'>
          <div className='container-fluid'>
            <div className='row my-md-5'>
              <ToggleBack name={'Approved Herbs'} />
              <div className='col-lg-10 mx-auto text-center mb-5'>
                <h4 className='sub-heading'>
                  CLEANSE, HEAL AND REVITALIZE YOUR BODY...
                </h4>
                <h3 className='main-heading'>YAH’KI APPROVED HERBS LIST</h3>
              </div>
              <div className='col-10 mx-auto'>
                <div className='row'>
                  ...
                  <div className='col-xl-3 col-lg-4 col-sm-6 mb-3'>
                    <div className='card card-body resource-body h-100'>
                      <h3 className='btn-resource border-0 hover-0'>Q</h3>
                      <ul>
                        <li className='my-2'>Quassia</li>
                      </ul>
                    </div>
                  </div>
                  <div className='col-xl-3 col-lg-4 col-sm-6 mb-3'>
