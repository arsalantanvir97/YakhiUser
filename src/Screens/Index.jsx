      ...
      <div>
                ...
                <div className="row justify-content-around align-items-center">
                  ...
                  <div className="col-lg-5 col-md-6">
                    <div className="category-tea">
                      <div className="position-relative">
                        <img
                          src="images/herbal-tea-bg.png"
                          alt=""
                          className="img-fluid"
                        />
                        <img
                          src="images/herbal-tea-anim.svg"
                          alt=""
                          className="img-fluid tea-anim"
                        />
                        <h4 className="herbal-tea-offer">SALE UP TO 40% OFF</h4>
                        <div className="cat-title-box">
                          <h3>Herbal Tea</h3>
                          <Link
                            to="/ViewCollection/HerbalTea"
                            className="red-link"
                          >
                            View Collection
                        ...
                        <img
                          src="images/red-hollow.svg"
                          alt=""
                          className="img-fluid red-hollow"
                        />
                      </div>
                    </div>
                    <div className="category-capsules">
                      <div className="position-relative">
                        <img
                          src="images/herbal-capsules-bg.png"
                          alt=""
                          className="img-fluid"
                        />
                        <img
                          src="images/herbal-capsules-anim.svg"
                          alt=""
                          className="img-fluid capsules-anim "
                        />
                        <div className="capsules-cat-title-box">
                          <h3>Herbal Capsules</h3>
                          <Link
                            to="/ViewCollection/HerbalCapsules"
                            className="red-link"
                          >
                            View Collection
                            {/* <span class="shadow-text"> View Collection</span> */}
                        ...
                        <img
                          src="images/star.svg"
                          alt=""
                          className="img-fluid star-spice"
                        />
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-5 col-md-6">
                    <div className="category-herbs">
                      <div className="position-relative">
                        <img
                          src="images/whole-herbs-bg.png"
                          alt=""
                          className="img-fluid"
                        />
                        <img
                          src="images/whole-herbs-anim.svg"
                          alt=""
                          className="img-fluid herbs-anim"
                        />
                        <h4 className="herbs-offer">NEW ARRIVALS</h4>
                        <div className="herbs-cat-title-box">
                          <h3>Whole hearbs</h3>
                          <Link
                            to="/ViewCollection/Herbal"
                            className="red-link"
                          >
                            View Collection
                            {/* <span class="shadow-text"> View Collection</span> */}
        ...
        <section className="selections">
                ...
                <div className="row justify-content-start mt-5 px-padding">
                  <div className="col-md-6 text-center">
                    <div className="selection-box mb-4 mb-md-0 animate__animated animate__fadeInUp">
                      <img
                        src="images/herbal-products-selection-1.jpg"
                        alt=""
                      ...
                      <h5 className="selection-title-lg">
                        ...
                        <img
                          ...
                          alt=""
                          className="img-fluid title-line"
                        />
                      </h5>
                    </div>
                  </div>
                  <div className="col-md-6 text-center">
                    <div className="selection-box mb-4 mb-md-0 animate__animated animate__fadeInUp">
                      <img
                        src="images/herbal-products-selection-2.jpg"
                        alt=""
                        className="img-fluid mb-0"
                      />
                    ...
                    <div className="row mt-4 px-md-0 px-sm-5 px-0">
                      <div className="col-md-6 col-6">
                        <div className="selection-box mb-4 mb-md-0 animate__animated animate__fadeInUp">
                          <img
                            src="images/herbal-products-selection-3.jpg"
                            alt=""
                            className="img-fluid mb-0"
                          />
                      ...
                      <div className="col-md-6 col-6">
                        <div className="selection-box mb-4 mb-md-0 animate__animated animate__fadeInUp">
                          <img
                            src="images/herbal-products-selection-4.jpg"
                            alt=""
                            className="img-fluid mb-0"
                          />
          ...
          <div className="scattered-images">
            <img
              src="images/selection-tea-leaf-1.svg"
              alt=""
              className="img-fluid scat-1 animate__animated animate__zoomIn"
            />
            <img
              src="images/selection-tea-leaf-2.svg"
              alt=""
              className="img-fluid scat-2 animate__animated animate__zoomIn"
            />
            <img
              src="images/selection-tea.png"
              alt=""
              className="img-fluid scat-3 animate__animated animate__zoomIn"
            />
          </div>
        </section>
              ...
              <div className="col-10 mx-auto">
                <div className="row align-items-center justify-content-center">
                  <div className="col-xl-6 col-lg-10">
                    <img
                      src="images/testimonial-aside.png"
                      alt=""
                      className="img-fluid"
                    />
                  </div>
                ...
                <div className="falling-leaves">
                  <div className="row justify-content-center align-items-center">
                    <div className="col-lg-6 text-center">
                      <img
                        src="images/yakhi-logo-light.png"
                        alt=""
                        className="img-fluid"
                      />
                      <p className="text-white">
                        Yah’ki Awakened LLC, where Peace, Health, Energy and
                        <br /> Awareness is always first priority
                      </p>
                      <a
                        href="#"
                  ...
                  <img
                    ...
                    alt=""
                    className="img-fluid f-1 falls"
                  />
                  <img
                    src="images/falling-leaf-2-image.png"
                    alt=""
                    className="img-fluid f-2 falls"
                  />
                </div>
              </div>
            </div>
