    ...
    <div className="col-11 mx-auto">
      ...
      <div className="row align-items-center mb-5 pb-5">
        ...
        <div className="col-md-6">
          ...
          <p className="general-para dark-text mt-3">
            The Yahki Detoxification Home was designed for those who want to naturally reverse aliments 
            and learn how to safely cleanse and detoxify their bodies on a cellular level. One does not have
            to be suffering from a particular illness to participate. For example, if you are seeking mental
            clarity or would simply like to complete a 2-week detox you are welcome to book your stay. Registrations
            are officially complete after your required video screening.
          </p>
        </div>
      ...
      <div className="mission mb-5 pb-5">
        <div className="row justify-content-center align-items-center">
          <div className="col-xl-7 col-lg-12 my-xl-0 my-5">
            ...
            <h3>PURPOSE</h3>
            <p>
              The purpose of the Yah’ki Detoxification Home is to provide full immersion in Yah’ki 
              Awakened Alkaline Healing and Revitalization techniques to Private Club members of Yah’ki
              Awakened Eye of Lotus Botanical Health Club. Private members will have the ability to cleanse 
              deeply and align themselves with all the elements of mind body and soul.
            </p>
            <p>
              Clients will be able to uplift their spirit and align themselves with nature by way of high 
              vibrational activities such as Meditation, Energy Healing, Breathing &amp; Stretching Exercising, 
              Sauna, Thermal Jacuzzi, Nature Walks, Gardening, Sound healing and much more.
            </p>
          </div>
          <div className="col-xl-5 col-lg-9 mx-auto text-center">
            <img src="images/detox-right.png" alt="" className="img-fluid" />
          </div>
        </div>
      </div>
      ...
      <div className="row align-items-center justify-content-between" id="detox-plans">
        <div className="col-md-6 my-4">
          <h3>YAH’KI Detox Home (2 Week)</h3>
          <h4 className="plan-price">$3000.00</h4>
          <p className="general-para dark-text my-3">
            You deserve healing! We are excited to announce that we are now accepting registration and bookings for 
            the Yah’ki Detoxification Home. This package is a two (2) week [14 days] stay at Yah’ki’s Detox Home for
            Alkaline Healing and Revitalization. Private members will have the ability to cleanse deeply and align 
            themselves with all the elements of mind body and soul.
          </p>
          <p className="general-para my-3">Package includes all food, personal items (toothbrush, toothpaste, soap, etc.), room and board.</p>
          <p className="red my-4 f-20">No refunds available for this product.</p>
          <a href="#" className="btn maroon-btn-solid" data-toggle="modal" data-target="#appointment"><img src="images/add-to-cart.png" alt="" className="img-fluid mr-2 pt-1" />Add to cart</a>
        </div>
        <div className="col-md-5 my-4 offset-xl-1 ">
          <img src="images/detox-2-week.png" alt="" className="img-fluid" />
        </div>
      </div>
      {/* FAQS */}
      <div className="col-10 mx-auto my-5">
        <h4 className="sub-heading text-center">Faqs</h4>
        <h3 className="main-heading text-center">Frequently Asked Questions</h3>
        ...
        <div className="faq-container my-3">
          ...
          <div className="faq ">
            ...
            <p className="faq-text">
              $1500 dollars per week includes herbs. There is a one-week minimum stay. Full payment will be required to book your stay.
            </p>
